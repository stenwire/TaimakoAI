...
export default function CataloguePage() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      setProducts([]); // Ensure products is not undefined on error
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={isEditModalOpen ? handleUpdateProduct : handleAddProduct} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 flex items-center gap-2">
              ...
              />
              <label htmlFor="is_active" className="text-sm font-medium cursor-pointer">Product is active and visible to AI</label>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="p-4 bg-blue-50 border border-blue-100 rounded-[var(--radius-md)]">
            ...
            <p className="text-xs text-blue-700">
              Your CSV should include headers: <code className="bg-blue-100 px-1 rounded">name, price, sku, description, category, stock_quantity</code>.
